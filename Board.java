...
public class Board extends JPanel implements KeyListener {
    ...
    protected void paintComponent(Graphics g) {
        ...
        g.drawString("SCORE", WindowGame.WIDTH - 115, WindowGame.HEIGHT / 2);
        g.drawString(score + "", WindowGame.WIDTH - 90, WindowGame.HEIGHT / 2 + 30);
        ...
        if(state == STATE_GAME_PAUSE) {
            g.setColor(Color.white);
            g.drawString("GAME PAUSE", 310, 200);
        }
    }
